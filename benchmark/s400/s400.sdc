...
set_output_delay 2.2 -max -rise [get_ports YLW1] -clock blif_clk_net
set_output_delay 2.2 -max -fall [get_ports YLW1] -clock blif_clk_net
...
set_output_delay 2.2 -max -rise [get_ports RED2] -clock blif_clk_net
set_output_delay 2.2 -max -fall [get_ports RED2] -clock blif_clk_net
...
set_output_delay 2.2 -max -rise [get_ports GRN1] -clock blif_clk_net
set_output_delay 2.2 -max -fall [get_ports GRN1] -clock blif_clk_net
...
set_output_delay 2.2 -max -rise [get_ports RED1] -clock blif_clk_net
set_output_delay 2.2 -max -fall [get_ports RED1] -clock blif_clk_net
...
set_output_delay 2.2 -max -rise [get_ports YLW2] -clock blif_clk_net
set_output_delay 2.2 -max -fall [get_ports YLW2] -clock blif_clk_net
...
set_output_delay 2.2 -max -rise [get_ports GRN2] -clock blif_clk_net
set_output_delay 2.2 -max -fall [get_ports GRN2] -clock blif_clk_net
